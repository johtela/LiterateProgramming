...
namespace LiterateProgramming
{
	...
	*/
	public class Options
	{
		...
		*/
		[Option ('e', "csext", DefaultValue = ".cs",
		...
		*/
		[Option ('d', "mdext", DefaultValue = ".md",
		...
		*/
		[Option ('r', "recursive", DefaultValue = false,
		...
		*/
		[Option ('f', "format", DefaultValue = OutputFormat.md,
		...
		*/
		[Option ('t', "trim", DefaultValue = false,
		...
		*/
		[Option ('u', "updatetoc", DefaultValue = false,
		...
		*/
		[Option ('m', "theme", DefaultValue = @"Themes\Default\DefaultTheme.dll",
		...
		*/
		...
		/*
		According to the Command Line Parser library documentation, the following property is 
		needed for the error message generation. It does not seem to do much, though.
		*/
		[ParserState]
		...
		/*
		### Usage Information
		To output the help text for the tool, we use the automatic facilities provided by the 
		parser library. 
		*/
		[HelpOption]
		public string GetUsage ()
		{
			...
			{
				current.AddPreOptionsLine ("Usage: csweave <filters> [options]");
